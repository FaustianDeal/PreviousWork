/*
 * Configuration to build output in production mode
 * process.env_NODE_ENV is 'development'
 * uses ../webpack.config.prod to generate non-minified output.
 */
...
webpack(getWebpackConfig(false)).run((err, stats) => {
  if (err) {
